...
import { KeyListenerContext } from "../context/key-listener-context";
...
export const ShowKeys: FC = () => {
  ...
  const keyListenerContext = useContext(KeyListenerContext);
  ...
  return (
    ...
    >
      <Text>show keys: keyEventLog={keyListenerContext.keyEventLog}</Text>
    </View>
  );
};
